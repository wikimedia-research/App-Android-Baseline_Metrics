...
- Overall stickiness is driven almost entirely by its stickiness in Europe (which was responsible for nearly half of all active users)
...
- Other than Australia & New Zealand (where the app has high stickiness relative to other regions), the app is doing poorly in Oceanic countries (which had less than 1.5K users)
